...
function PlayerControls({
  ...
  return (
    <div className="player-controls-wrapper" style={{ pointerEvents }}>
      ...
      <div className="control-icons-row">
        ...
        <div className="col col-2">
          <Dropdown overlay={optionsRewind} placement="topCenter" arrow>
            <Button type="text" className="control-icon big-icon">
              <LeftRewind rotate="-180" />
            </Button>
          </Dropdown>
          <Button type="text" className="control-icon big-icon" disabled={true}>
            <FastRewind />
          </Button>
          <Button type="text" onClick={togglePlay} className="control-icon big-icon">
            {isPlaying ? (
              <PauseOutlined style={{ marginTop: '5px' }} />
            ) : (
              <PlayArrow style={{ width: '30px' }} />
            )}
          </Button>
          <Button type="text" className="control-icon big-icon" disabled={true}>
            <FastForward className="control-icon big-icon" />
          </Button>
          {isLive ? (
            <></>
          ) : (
            <Dropdown overlay={optionsForward} placement="topCenter" arrow>
              <Button type="text" className="control-icon big-icon">
                <RightRewind rotate="-180" />
              </Button>
            </Dropdown>
          )}
        </div>
        <div className="col col-3">
          <span className="clip-btn btn" onClick={clip}>
            Clip
          </span>
          <span
            className="screen-btn btn"
            onClick={() => {
          ...
          <Button type="text" className="control-icon control-icon-last" onClick={handle.enter}>
