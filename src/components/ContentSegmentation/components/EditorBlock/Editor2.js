...
import './editor.scss';
function Editor2({textFile,setTextFile}) {
  ...
  return (
    <div>
      ...
      init={{
        ...
        content_style: "body { background-color:#5C6275;color:white }  .tox :not(svg):not(rect) {background: #5C6275}",
        // content_css:"./editor2.scss",
        toolbar: 'undo redo h1 h2 h3 backcolor forecolor bold italic underline alignleft aligncenter alignright',
