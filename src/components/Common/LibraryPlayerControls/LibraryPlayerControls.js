...
import './LibraryPlayerControls.scss';
import { Card } from 'components/Common';
import { useHotkeys } from 'react-hotkeys-hook';
import { TOOLTIP_COLORS } from 'constants/options';
import { SpeakerIcon, MuteIcon, PlayC, PreviousC, NextC, UndoC, RedoC } from 'assets/icons';
import { UPDATE_SEGMENT_TIME } from 'modules/common/actions';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { Slider, Typography, Menu, Dropdown, Button, Tooltip } from 'antd';
...
const LibraryPlayerControls = ({
  ...
  const menu3 = (
    <Menu style={{ minWidth: '50px', padding: '5px 10px 5px 0px', backgroundColor: '#303030' }}>
  ...
  return (
    <div className="controls-wrapper">
      <Card bg="medium" content={content} />
    </div>
  );
};
