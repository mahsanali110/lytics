...
const api = {
  ...
  addAssociation: async newAssociation => request.post('/associations', newAssociation),
  getAssociation: async associationId => request.get(`/associations/${associationId}`),
  updateAssociation: async ({ associationId, data }) =>
    request.patch(`/associations/${associationId}`, data),
  deleteAssociation: async associationId => request.delete(`/associations/${associationId}`),
};
