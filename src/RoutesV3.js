...
import { MinimalLayout3, MainLayout3 } from 'V3/layouts';
...
import { Login, ClientLibrary, MapComponent } from 'V3/components';
...
import NewsBoardNew from 'components/NewsBoardNew/NewsBoardNew';
    ...
    >
      <Switch>
        ...
        <RouteWithLayout
          ...
          protectedRoute
        />
        <RouteWithLayout component={Login} exact layout={MinimalLayout3} path="/login" />
        <RouteWithLayout
